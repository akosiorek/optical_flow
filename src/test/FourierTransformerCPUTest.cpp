...
class FourierTransformerCPUTest : public testing::Test {
...
TEST_F(FourierTransformerCPUTest, ConstructorTest)
{
...
TEST_F(FourierTransformerCPUTest, ForwardTestMatrixSizes)
{
...
TEST_F(FourierTransformerCPUTest, BackwardTestMatrixSizes)
{
...
TEST_F(FourierTransformerCPUTest, FowardInputConsistency)
{
...
TEST_F(FourierTransformerCPUTest, ForwardBackwardScaling)
{
	RealMatrix 		rm(ftfftw->rows_,ftfftw->rows_);
...
TEST_F(FourierTransformerCPUTest, FwdBwdFilterTest)
{
