...
FourierTransformerCUFFTW::~FourierTransformerCUFFTW()
{
	/* Free plan memory */
...
void FourierTransformerCUFFTW::forward(const RealMatrix& src, ComplexMatrix& dst) const 
{
	LOG_FUN_START;
...
void FourierTransformerCUFFTW::backward(const ComplexMatrix& src, RealMatrix& dst) const
{
	LOG_FUN_START;
