...
The evaluation speed hereby primarily depends on the temporal granularity of the event slices, henceforth the \textit{time slice duration}, sensor size, and filter size.
