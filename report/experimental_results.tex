...
As real-time can only be achieved for the sequential implemention with parameter settings which no practical relevances (e.g., incorrect results), the evaluation is not considered in the scope of this report.
