...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[height=.3\linewidth]{figs/defect-pixels/defect-quadrat.png}
  \caption{}
\end{subfigure}
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[height=.3\linewidth]{figs/defect-pixels/cleaned-quadrat.png}  \caption{}
\end{subfigure}
...
In the second scene, a small robot is approaching to the DVS sensor.
