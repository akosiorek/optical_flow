...
An ES is a (sparse) \edit{square matrix}{We could mention that in future implementations, the algorithm will be used for non-square matrices (e.g. DAVIS DVS with 240x180 resolution)}, with the number of entries equal to that of the DVS camera and their value being the sum of events which occurred at a given location. 
